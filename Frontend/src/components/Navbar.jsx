...
function Navbar() {
    ...
    const navItems = (
        <>
            <li >
                <a className='dark:bg-slate-800 dark:text-white' href='/'>Home</a>
            </li>
            <li>
                <Link className='dark:bg-slate-800 dark:text-white' to="/course">Course</Link>
            </li>
            <li>
                <Link className='dark:bg-slate-800 dark:text-white' to="/contact">Contact</Link>
            </li>
            <li>
                ...
                <div className="navbar">
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul
                                tabIndex={0}
                                className=" menu dark:bg-slate-800 dark:text-white menu-sm dropdown-content rounded-box z-[1] mt-3 w-52 p-2 shadow">
                                {navItems}
                            </ul>
                        </div>
                        <a className=" text-2xl font-bold cursor-pointer">bookStore</a>
                    </div>
                    <div className='navbar-end dark:bg-slate-800 dark:text-white space-x-3  '>
